...
\phpinputminted{04/figures/01/15-MailerInterface}
...
\phpinputminted{04/figures/01/16-Mail-interface}

We would use it in \texttt{MailingList} in exactly the same way:

\phpinputminted{04/figures/01/17-MailingList-interface}
...
\phpinputminted{04/figures/01/18-MailChimp}
...
\phpinputminted{04/figures/01/07-Mailer}
...
\phpinputminted{04/figures/01/08-Mailer-children}
...
\phpinputminted{04/figures/01/09-MailingListRedux}
...
\phpinputminted{04/figures/01/10-Mailer-oops}
...
\phpinputminted{04/figures/01/11-Mailer-redux}
...
\phpinputminted{04/figures/01/12-override}
...
\phpinputminted{04/figures/01/13-Mailer-final}
...
\phpinputminted{04/figures/01/14-parent}
