...
\php{...}{04/figures/01/15-MailerInterface}
...
\php{...}{04/figures/01/16-Mail-interface}

We would use it in \texttt{MailingList} in exactly the same way:

\php{...}{04/figures/01/17-MailingList-interface}
...
\php{...}{04/figures/01/18-MailChimp}
...
\php{...}{04/figures/01/08-Mailer-children}
...
\php{...}{04/figures/01/09-MailingListRedux}
...
\php{...}{04/figures/01/11-Mailer-redux}
...
\php{...}{04/figures/01/13-Mailer-final}
