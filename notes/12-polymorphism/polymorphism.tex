...
\php{MailInterface.php}{12-polymorphism/figures/01-MailInterface}
...
\php{Mail.php}{12-polymorphism/figures/02-Mail}
...
\php{MailChimp.php}{12-polymorphism/figures/03-MailChimp}

And use it instead:

\php{}{12-polymorphism/figures/04-app}
...
\php{Mailer.php}{12-polymorphism/figures/05-Mailer}
...
\php{Mail.php}{12-polymorphism/figures/06-Mail}
...
\php{Mailer.php}{12-polymorphism/figures/07-MailerRedux}
...
\php{MailChimp.php}{12-polymorphism/figures/08-override}
...
\php{Mailer.php}{12-polymorphism/figures/09-final}
...
\php{MailChimp.php}{12-polymorphism/figures/10-parent}
